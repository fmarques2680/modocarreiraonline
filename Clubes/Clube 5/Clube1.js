...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado5" do Local Storage
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela5', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual5 do localStorage
        var anoAtual5 = parseInt(localStorage.getItem('anoAtual5')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual5 + "/" + (anoAtual5 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual5 = parseInt(localStorage.getItem('anoAtual5')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual5++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual5 + "/" + (anoAtual5 + 1);
        ...
        // Salva o anoAtual5 no localStorage
        localStorage.setItem('anoAtual5', anoAtual5);
