...
window.addEventListener("load", function () {
    ...
    if (clubeSelecionado10 !== null) {
        var divclubeSelecionado10 = document.getElementById("clubeInfo");

        divclubeSelecionado10.innerText = clubeSelecionado10;
    }
});
...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado10" do Local Storage
    var clubeSelecionado10 = localStorage.getItem('clubeSelecionado10');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela10', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual10 do localStorage
        var anoAtual10 = parseInt(localStorage.getItem('anoAtual10')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual10 + "/" + (anoAtual10 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual10 = parseInt(localStorage.getItem('anoAtual10')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual10++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual10 + "/" + (anoAtual10 + 1);
        ...
        // Salva o anoAtual10 no localStorage
        localStorage.setItem('anoAtual10', anoAtual10);
