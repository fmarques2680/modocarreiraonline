...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado9" do Local Storage
    var clubeSelecionado9 = localStorage.getItem('clubeSelecionado9');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela9', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual9 do localStorage
        var anoAtual9 = parseInt(localStorage.getItem('anoAtual9')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual9 + "/" + (anoAtual9 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual9 = parseInt(localStorage.getItem('anoAtual9')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual9++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual9 + "/" + (anoAtual9 + 1);
        ...
        // Salva o anoAtual9 no localStorage
        localStorage.setItem('anoAtual9', anoAtual9);
