...
window.addEventListener("load", function () {
    ...
    if (clubeSelecionado3 !== null) {
        var divclubeSelecionado3 = document.getElementById("clubeInfo");

        divclubeSelecionado3.innerText = clubeSelecionado3;
    }
});
...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado3" do Local Storage
    var clubeSelecionado3 = localStorage.getItem('clubeSelecionado3');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela3', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual3 do localStorage
        var anoAtual3 = parseInt(localStorage.getItem('anoAtual3')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual3 + "/" + (anoAtual3 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual3 = parseInt(localStorage.getItem('anoAtual3')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual3++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual3 + "/" + (anoAtual3 + 1);
        ...
        // Salva o anoAtual3 no localStorage
        localStorage.setItem('anoAtual3', anoAtual3);
