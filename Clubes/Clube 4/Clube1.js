...
window.addEventListener("load", function () {
    ...
    if (clubeSelecionado4 !== null) {
        var divclubeSelecionado4 = document.getElementById("clubeInfo");

        divclubeSelecionado4.innerText = clubeSelecionado4;
    }
});
...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado4" do Local Storage
    var clubeSelecionado4 = localStorage.getItem('clubeSelecionado4');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela4', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual4 do localStorage
        var anoAtual4 = parseInt(localStorage.getItem('anoAtual4')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual4 + "/" + (anoAtual4 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual4 = parseInt(localStorage.getItem('anoAtual4')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual4++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual4 + "/" + (anoAtual4 + 1);
        ...
        // Salva o anoAtual4 no localStorage
        localStorage.setItem('anoAtual4', anoAtual4);
