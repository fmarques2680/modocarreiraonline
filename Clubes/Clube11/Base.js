...
//FINALIZAR CLICANDO NO BOTÃO "OK"
    ...
    finalizarTudo.addEventListener("click", function() {
        ...
        var dadosTabela11 = JSON.parse(localStorage.getItem('dadosTabela11')) || [];

        // Adicionar o novo item ao array
        dadosTabela11.push(novoItem);

        // Armazenar de volta no localStorage
        localStorage.setItem('dadosTabela11', JSON.stringify(dadosTabela11));
    });
