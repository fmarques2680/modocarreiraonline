...
window.addEventListener("load", function () {
    ...
    if (clubeSelecionado11 !== null) {
        var divclubeSelecionado11 = document.getElementById("clubeInfo");

        divclubeSelecionado11.innerText = clubeSelecionado11;
    }
});
...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado11" do Local Storage
    var clubeSelecionado11 = localStorage.getItem('clubeSelecionado11');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela11', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual11 do localStorage
        var anoAtual11 = parseInt(localStorage.getItem('anoAtual11')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual11 + "/" + (anoAtual11 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual11 = parseInt(localStorage.getItem('anoAtual11')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual11++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual11 + "/" + (anoAtual11 + 1);
        ...
        // Salva o anoAtual11 no localStorage
        localStorage.setItem('anoAtual11', anoAtual11);
