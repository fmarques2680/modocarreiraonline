...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado8" do Local Storage
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela8', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual8 do localStorage
        var anoAtual8 = parseInt(localStorage.getItem('anoAtual8')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual8 + "/" + (anoAtual8 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual8 = parseInt(localStorage.getItem('anoAtual8')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual8++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual8 + "/" + (anoAtual8 + 1);
        ...
        // Salva o anoAtual8 no localStorage
        localStorage.setItem('anoAtual8', anoAtual8);
