...
window.addEventListener("load", function () {
    ...
    if (clubeSelecionado7 !== null) {
        var divclubeSelecionado7 = document.getElementById("clubeInfo");

        divclubeSelecionado7.innerText = clubeSelecionado7;
    }
});
...
// LOCAL STORAGE
    ...
    // Recupere o valor armazenado na chave "clubeSelecionado7" do Local Storage
    var clubeSelecionado7 = localStorage.getItem('clubeSelecionado7');
    ...
    function salvarDadosLocalStorage() {
        ...
        localStorage.setItem('dadosTabela7', JSON.stringify(dados));
    }
    ...
    function carregarDadosLocalStorage() {
        ...
        // Carregar a variável anoAtual7 do localStorage
        var anoAtual7 = parseInt(localStorage.getItem('anoAtual7')) || 2023;
        ...
        if (temporadaAtual) {
            temporadaAtual.textContent = textoTemporadaAtual + " " + anoAtual7 + "/" + (anoAtual7 + 1);
        }
    }
...
//A PARTIR DAQUI, A LÓGICA BÁSICA DA TABELA ESTÁ FEITA. AGORA HAVERÃO AS ALTERAÇÕES DA TABELA DE ACORDO COM AS TEMPORADAS PASSANDO.
    ...
    let anoAtual7 = parseInt(localStorage.getItem('anoAtual7')) || 2023;
    ...
    botaoFimTemporada.addEventListener("click", () => {
        anoAtual7++;
        temporadaAtual.textContent = "Temporada" + " " + anoAtual7 + "/" + (anoAtual7 + 1);
        ...
        // Salva o anoAtual7 no localStorage
        localStorage.setItem('anoAtual7', anoAtual7);
