...
//FINALIZAR CLICANDO NO BOTÃO "OK"
    ...
    finalizarTudo.addEventListener("click", function() {
        ...
        var dadosTabela10 = JSON.parse(localStorage.getItem('dadosTabela10')) || [];

        // Adicionar o novo item ao array
        dadosTabela10.push(novoItem);

        // Armazenar de volta no localStorage
        localStorage.setItem('dadosTabela10', JSON.stringify(dadosTabela10));
    });
